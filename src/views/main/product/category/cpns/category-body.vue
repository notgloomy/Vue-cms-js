...
import { ReqDeleteGoodsCategory } from '@/apis/goods.js'
...
const handlerDelete = async (id) => {
  // 删除逻辑操作
  await ReqDeleteGoodsCategory(id)
...
// 封装获取用户列表
const handleGetGoodCategoryList = (searchForm = {}) => {
  ...
  goodStore.getGoodCategoryList(endList)
}
handleGetGoodCategoryList()
const { goodCategoryList, listCount } = storeToRefs(goodStore)
console.log(goodCategoryList)
// 向外暴露获取用户列表
defineExpose({ handleGetGoodCategoryList })
</script>

<template>
  <div class="body">
    <div class="body-header">
      <div class="headerText">商品类别列表</div>
      <el-button type="primary" @click="handlerCreateUser" v-if="isCreate"
        >新建类别</el-button
      >
    </div>
    <div class="body-table">
      <el-table :data="goodCategoryList" border style="width: 100%">
